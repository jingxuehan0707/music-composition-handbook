...
| Scale degree | 1 | 2 | b3 | 4 | 5 | b6 | 6 | b7 | 7 | 1 |
|--------------|---|---|----|---|---|----|---|----|---|---|
| Solfege      | Do| Re| Me | Fa| Sol| Le | La| Te | Ti| Do|

The composite minor scale blends four minor scales.

| Composite Minor | 1 | 2 | b3 | 4 | 5 | b6 | 6 | b7 | 7 | 1 |
|-----------------|---|---|----|---|---|----|---|----|---|---|
| Natural Minor   | 1 | 2 | b3 | 4 | 5 | b6 |   | b7 |   | 1 |
| Dorian          | 1 | 2 | b3 | 4 | 5 |    | 6 | b7 |   | 1 |
| Harmonic Minor  | 1 | 2 | b3 | 4 | 5 | b6 |   |    | 7 | 1 |
| Jazz Minor      | 1 | 2 | b3 | 4 | 5 |    | 6 |    | 7 | 1 |

### Example in A Minor

| Composite Minor | A | B | C | D | E | F | F# | G | G# | A |
|-----------------|---|---|---|---|---|---|----|---|----|---|
| Natural Minor   | A | B | C | D | E | F |    | G |    | A |
| Dorian          | A | B | C | D | E |   | F# | G |    | A |
| Harmonic Minor  | A | B | C | D | E | F |    |   | G# | A |
| Jazz Minor      | A | B | C | D | E |   | F# |   | G# | A |

### All 7th Chords from Composite Minor

| Composite Minor | A-7, A-maj7 | B-7b5, B-7 | Cmaj7, C+maj7 | D-7, D7, D-6 | E-7, E7 | Fmaj7 | F#-7b5 | G7 | G#°7 | A-6 |
|-----------------|-------------|-----------|---------------|-------------|---------|--------|--------|-----|------|-----|
| Natural Minor   | A-7         | B-7b5     | Cmaj7         | D-7         | E-7     | Fmaj7  |        | G7  |      | A-7 |
| Dorian          | A-7         | B-7       | Cmaj7         | D7          | E-7     |        | F#-7b5 | Gmaj7 |      | A-6 |
| Harmonic Minor  | A-maj7      | B-7b5     | C+maj7        | D-7         | E7      | Fmaj7  |        |     | G#°7 | A-maj7 |
| Jazz Minor      | A-maj7      | B-7       | C+maj7        | D7          | E7      |        | F#-7b5 |     | G#-7b5 | A-6 |

Here is a chart of the Roman numerals for the triads, 6th and 7th chords broken down into their scale degree or root designation. As you can see, there are a lot more chords that are part of minor key than major key! This chart also shows the optional choice of using a major 6 chord for bIII, IV, and bVI.

| All Diatonic Minor Key Chords |
|------------------------------|
| I-, I-6, I-7, I-maj7         |
| II°, II-, II-7, II-7b5       |
| bIII, bIII+, bIII6, bIIImaj7, bIII+maj7 |
| IV-, IV, IV-6, IV6, IV-7, IV7 |
| V-, V, V-7, V7               |
